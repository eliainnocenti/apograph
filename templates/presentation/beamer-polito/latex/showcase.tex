...
\input{sections/02-getting-started}
\input{sections/03-colors-styles}
\input{sections/04-layout-elements}
\input{sections/05-custom-boxes}
\input{sections/06-diagrams-tables}
\input{sections/07-special-slides}
