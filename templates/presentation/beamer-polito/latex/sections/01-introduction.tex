...
\begin{itemize}
    ...
    \item \textbf{Beamer-LaTeX-Themes Derivation}: Contributed to by Liu Qilong and Andrea Gasparini.
...
\vspace{0.3cm}
\begin{center}
    \footnotesize Released under \hrefcol{https://creativecommons.org/licenses/by-nc/4.0/legalcode}{Creative Commons CC BY 4.0} and GPL v3.
\end{center}
\end{frame}
