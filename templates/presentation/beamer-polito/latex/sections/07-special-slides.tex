...
\begin{chapter}[theme/assets/background_negative]{}{Chapter Divider Slides}
\begin{itemize}
...
\begin{sidepic}{theme/assets/background_alternative}{Side-Picture Slides}
\begin{itemize}
    \item Opened with: \\
    \texttt{\textbackslash begin\{sidepic\}\{<image>\}\{<Title>\}}
...
\begin{itemize}
    \item Call \verb|\backmatter| at the very end of your document:
