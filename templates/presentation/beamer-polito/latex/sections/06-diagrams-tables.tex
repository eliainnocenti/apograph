...
\centering
\begin{tikzpicture}[
    nodeDistance/.style={shape=rectangle, rounded corners=4pt, draw=apographpolito-primary, fill=apographpolito-light, minimum width=2.4cm, minimum height=1.0cm, font=\scriptsize\bfseries, align=center},
    arrow/.style={-{Stealth[length=3mm]}, thick, apographpolito-primary}
]
    % Nodes
...
\begin{columns}[T]
    \begin{column}{0.48\textwidth}
        ...
        \begin{itemize}
            ...
            \item Style frames using \texttt{apographpolito-primary} and \texttt{apographpolito-light}.
        \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
        \footnotesize
...
\begin{columns}[T]
    \begin{column}{0.45\textwidth}
        ...
        \vspace{0.2cm}
        \begin{tikzpicture}[
            box/.style={draw=apographpolito-primary, fill=apographpolito-light, rounded corners=3pt,
            ...
            arrow/.style={-{Stealth[length=2.5mm]}, thick, apographpolito-primary},
        ]
    ...
    \begin{column}{0.50\textwidth}
        \begin{highlightbox}{apographpolito-primary}
